...
//custom blocks for rotrics-studio-app
...
Blockly.Blocks['motion_move_home'] = {
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.MOTION_MOVE_HOME,
      "category": Blockly.Categories.motion,
      "extensions": ["colours_motion", "shape_statement"]
    });
  }
...
Blockly.Blocks['motion_move_origin'] = {
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.MOTION_MOVE_ORIGIN,
      "category": Blockly.Categories.motion,
      "extensions": ["colours_motion", "shape_statement"]
    });
  }
...
Blockly.Blocks['motion_move_position'] = {
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.MOTION_MOVE_POSITION,
      "args0": [
        {
          "type": "input_value",
          "name": "X"
...
Blockly.Blocks['motion_set_work_origin'] = {
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.MOTION_SET_WORK_ORIGIN,
      "category": Blockly.Categories.motion,
      "extensions": ["colours_motion", "shape_statement"]
    });
  }
